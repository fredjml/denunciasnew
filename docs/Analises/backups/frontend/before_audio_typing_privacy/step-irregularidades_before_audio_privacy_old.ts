  ...
  private async startRecording(): Promise<void> {
    try {
      ...
      this.mediaRecorder.onstop = () => {
        ...
        //
        //---> Duas linhas criadas para depurar o teste de envio de audio
        const bloblur = URL.createObjectURL(audioBlob);
        console.log('Áudio na memória. Clique para ouvir/baixr:', bloblur);
        //  
      ...
      // Opcional: mostrar um alerta para o usuário saber exatamente por que falhou
